...
```bash
# Scaffold a new site
sh internal/agent/kits/static-web/scripts/scaffold-static.sh /tmp/my-site "My Site"

# Build and run checks
sh internal/agent/kits/static-web/scripts/check-all.sh /tmp/my-site

# Serve source and built outputs
sh internal/agent/kits/static-web/scripts/dev.sh /tmp/my-site
sh internal/agent/kits/static-web/scripts/preview.sh /tmp/my-site
```

## Make targets (from `internal/agent/kits/static-web`)

```bash
cd internal/agent/kits/static-web
