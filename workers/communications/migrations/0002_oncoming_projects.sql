...
INSERT OR REPLACE INTO oncoming_projects (
  ...
  ('the-early-works-of-john-gould-fletcher', 'master-canon-structure', 'library-of-the-southern-civilization', 'Library of the Southern Civilization', 'southern-modernist-core', 'Southern Modernist Core', 'C. Sandbatch', 'The Early Works of John Gould Fletcher', 'Scholarly monograph; historical-critical reconstruction', NULL, 'planned', 145, 'Intellectual hinge between scholarship and Southern canon reprints.'),
