...
- Keep package scripts, Makefile targets, script docs, and `../ONTOLOGY.md` synchronized when commands change.
- Prefer deterministic checks and clear failure messages.

Closeout:

- Update `../ONTOLOGY.md` and `../AGENTS.md` after script path or command changes.
